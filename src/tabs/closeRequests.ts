 ...
 *
 * Follows the existing `tasknode-stop-request` / `reveal-file-in-tree`
 * precedent. PR 2 lifts the controller into `AppShell`, at which point this
 * can become a plain prop again if that reads better.
 */
